...
4. Also read `__USER_HOME__/projects/se-core/core-rules/deferred.md` — this is the promotion queue. Entries here are waiting for more data points before graduation.
...
Write to `__USER_HOME__/projects/se-core/audits/YYYY-MM-DD-gotchas-rollup.md` (monthly):
