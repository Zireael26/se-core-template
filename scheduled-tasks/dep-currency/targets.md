...
E.g.:
```
# project-e: registry=https://registry.private.example
```
...
```
# project-f: Unity Package Manager has no public registry HTTP endpoint comparable to npm/pypi; tracked manually via dep-major-upgrade-watch watchlist.
```
